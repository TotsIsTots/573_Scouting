...
If git is installed, you can copy and paste this command to clone this repository and install required packages at the same time: `git clone https://github.com/TotsIsTots/573_Scouting && pip install pygame qrcode Pillow tbapy pyperclip`
